                ...
                <header class="entry-header">
                  <section class="entry-metadata">
                    <section class="entry-data">
                      ...
                      ?>
                      <h4 class="comments-number"><i class="fas fa-comment"></i> <?php comments_number('Aucun commentaire', '1 commentaire', '% commentaires'); ?></h4>
                    </section>
                  ...
                  <?php
                    if(has_post_thumbnail()) :
                      ...
                      the_post_thumbnail('full', ['class' => 'featured-image', 'title' => $thumbnail_title, 'alt' => $thumbnail_alt]);
                    endif;
                  ?>
                </header>
                ...
                <footer class="entry-footer">
                  <section class="author-card">
                    ...
                    <section class="author-metadata">
                      <h3 class="author-meta-name"><a href="<?php get_author_posts_url(get_the_author_meta('ID')); ?>"><?php the_author(); ?></a></h3>
